...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actCal_strength = QtWidgets.QAction(MainWindow)
        self.actCal_strength.setObjectName("actCal_strength")
        ...
        self.actPaint_strenth = QtWidgets.QAction(MainWindow)
        self.actPaint_strenth.setObjectName("actPaint_strenth")
        ...
        self.menu_2.addAction(self.actCal_strength)
        self.menu_2.addAction(self.actCal_fi)
        self.menu_2.addAction(self.actCal_cor)
        self.menu_P.addAction(self.actPaint_strenth)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actPaint_strenth.setText(_translate("MainWindow", "岩石力学强度曲线"))
